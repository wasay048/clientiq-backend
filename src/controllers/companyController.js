...
const generateResearch = async (req, res) => {
    try {
        ...
        console.log(`🔍 Generating research for ${companyName} by user ${req.user.email}`);
        ...
        const research = new Research({
            ...
            promptUsed: `Company research for ${companyName} - ${userRole} user`
        });
        ...
        res.status(500).json({
            ...
            message: 'An error occurred while generating company research'
        });
    }
};
